...
export const SEO_PRESETS: SeoPreset[] = [
  {
    ...
    metaDescription: 'Calculate AI costs for early-stage startups. Compare GPT-5.2 vs Claude Sonnet 4.6 vs DeepSeek V3 for 500 daily messages. Find the most cost-effective LLM for your MVP.',
    params: {
      messagesPerDay: 500,
      tokensInput: 150,
      tokensOutput: 300,
